 ...
 */
class User extends \App\Models\Objects\Entities\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'email', 'account', 'externalReference', '' . "\0" . 'App\\Models\\Objects\\Entities\\User' . "\0" . 'createdAt', '' . "\0" . 'App\\Models\\Objects\\Entities\\User' . "\0" . 'updatedAt', '' . "\0" . 'App\\Models\\Objects\\Entities\\User' . "\0" . 'deletedAt'];
        }
